...
function TaskName() {
  ...
  return /*html*/ `
      <article id='task-article'>
        ...
        <img src='images/check.png' alt='Completar tarefa' onclick='taskName.handdleClick(event)' id='check-icon'>
        <img src='images/delete.png' alt='Deletar tarefa' onclick='taskName.delete(event)' id='delete-icon'>
      </article>
    `;
}
